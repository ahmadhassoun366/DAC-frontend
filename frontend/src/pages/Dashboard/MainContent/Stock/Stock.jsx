            ...
            <div class="flex justify-around p-10 gap-8">
                <div class="max-w-md py-4 px-8 bg-white shadow-lg rounded-lg">
                    ...
                    <div>
                        ...
                        <button class="mt-4 bg-cyan-600 text-white px-2 py-2 rounded inline-flex items-center">Navigate</button>
                    </div>
                </div>
                <div class="max-w-md py-4 px-8 bg-white shadow-lg rounded-lg">
                    <div class="flex justify-center md:justify-end -mt-16">
                ...
                <div class="max-w-md py-4 px-8 bg-white shadow-lg rounded-lg">
                    ...
                    <div>
                        ...
                        <button class="mt-4  text-white px-2 py-2 rounded inline-flex items-center bg-cyan-600">Navigate</button>
                    </div>
                </div>
            </div>
        </div>
