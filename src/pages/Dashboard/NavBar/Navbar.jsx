        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center justify-start">
            ...
            <div className="ml-10 flex justify-center items-center gap-5">
              ...
              />
              <Link
                className="self-center whitespace-nowrap text-white font-bold text-3xl"
                to="/"
              >
                DAC
              </Link>
              ...
              <div class="mt-1 relative lg:w-64">
                ...
                <input
                  ...
                  class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg 
                                     focus:ring-cyan-600 focus:border-cyan-600 block w-full pl-10 p-2.5"
                  placeholder="Search"
                />
              </div>
            </form>
          ...
          <div class="flex items-center">
            ...
            <div class="hidden lg:flex items-center ">
              <button
                class="text-base font-bold text-white mr-5 hover:bg-white px-3 py-2 rounded-lg hover:text-gray-900"
